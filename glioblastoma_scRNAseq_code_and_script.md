...
발표 마지막 문장은 이렇게 하시면 됩니다.

**“즉, 이 코드는 단일세포 RNA-seq 데이터에서 품질 관리와 전처리를 수행한 뒤, Harmony를 통해 배치 효과를 보정하고, 최종적으로 세포 군집을 시각화하여 생물학적 차이를 더 정확하게 해석할 수 있도록 구성된 분석 파이프라인입니다.”**
